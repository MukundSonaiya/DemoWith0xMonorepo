...
var DummyTokenContract = /** @class */ (function (_super) {
    __extends(DummyTokenContract, _super);
    function DummyTokenContract(abi, address, provider, txDefaults) {
        var _this = _super.call(this, 'DummyToken', abi, address, provider, txDefaults) || this;
        _this.setBalance = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_target, _value], base_contract_1.BaseContract._bigNumberToString.bind(self)), _target = _a[0], _value = _a[1];
                                encodedData = self
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('setBalance(address,uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_target, _value], base_contract_1.BaseContract._bigNumberToString), _target = _a[0], _value = _a[1];
                                encodedData = self
                                    ._lookupEthersInterface('setBalance(address,uint256)')
                                    .functions.setBalance(_target, _value).data;
    ...
    DummyTokenContract.deployFrom0xArtifactAsync = function (artifact, provider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            var bytecode, abi;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, DummyTokenContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    DummyTokenContract.deployAsync = function (bytecode, abi, provider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("DummyToken successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new DummyTokenContract(abi, txReceipt.contractAddress, provider, txDefaults);
