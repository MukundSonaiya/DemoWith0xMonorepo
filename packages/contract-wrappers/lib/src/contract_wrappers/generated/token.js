...
var TokenContract = /** @class */ (function (_super) {
    __extends(TokenContract, _super);
    function TokenContract(abi, address, provider, txDefaults) {
        var _this = _super.call(this, 'Token', abi, address, provider, txDefaults) || this;
        _this.approve = {
    ...
    TokenContract.deployFrom0xArtifactAsync = function (artifact, provider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            var bytecode, abi;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, TokenContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    TokenContract.deployAsync = function (bytecode, abi, provider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("Token successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TokenContract(abi, txReceipt.contractAddress, provider, txDefaults);
