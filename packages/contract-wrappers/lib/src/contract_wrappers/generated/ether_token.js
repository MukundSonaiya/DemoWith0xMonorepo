...
var EtherTokenContract = /** @class */ (function (_super) {
    __extends(EtherTokenContract, _super);
    function EtherTokenContract(abi, address, provider, txDefaults) {
        var _this = _super.call(this, 'EtherToken', abi, address, provider, txDefaults) || this;
        _this.name = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_spender, _value], base_contract_1.BaseContract._bigNumberToString.bind(self)), _spender = _a[0], _value = _a[1];
                                encodedData = self
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('approve(address,uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_spender, _value], base_contract_1.BaseContract._bigNumberToString), _spender = _a[0], _value = _a[1];
                                encodedData = self
                                    ._lookupEthersInterface('approve(address,uint256)')
                                    .functions.approve(_spender, _value).data;
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_from, _to, _value], base_contract_1.BaseContract._bigNumberToString.bind(self)), _from = _a[0], _to = _a[1], _value = _a[2];
                                encodedData = self
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('transferFrom(address,address,uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_from, _to, _value], base_contract_1.BaseContract._bigNumberToString), _from = _a[0], _to = _a[1], _value = _a[2];
                                encodedData = self
                                    ._lookupEthersInterface('transferFrom(address,address,uint256)')
                                    .functions.transferFrom(_from, _to, _value).data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
        ...
        _this.withdraw = {
            sendTransactionAsync: function (amount, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                amount = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [amount], base_contract_1.BaseContract._bigNumberToString.bind(self))[0];
                                encodedData = self._lookupEthersInterface('withdraw(uint256)').functions.withdraw(amount).data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.withdraw.estimateGasAsync.bind(self, amount))];
                            case 1:
            ...
            estimateGasAsync: function (amount, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('withdraw(uint256)').inputs;
                                amount = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [amount], base_contract_1.BaseContract._bigNumberToString)[0];
                                encodedData = self._lookupEthersInterface('withdraw(uint256)').functions.withdraw(amount).data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                txDataWithDefaults = _a.sent();
            ...
            getABIEncodedTransactionData: function (amount) {
                var self = this;
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _owner = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_owner], base_contract_1.BaseContract._bigNumberToString.bind(self))[0];
                                ethersFunction = self
                                    ._lookupEthersInterface(functionSignature)
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_to, _value], base_contract_1.BaseContract._bigNumberToString.bind(self)), _to = _a[0], _value = _a[1];
                                encodedData = self._lookupEthersInterface('transfer(address,uint256)').functions.transfer(_to, _value)
                                    .data;
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('transfer(address,uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_to, _value], base_contract_1.BaseContract._bigNumberToString), _to = _a[0], _value = _a[1];
                                encodedData = self._lookupEthersInterface('transfer(address,uint256)').functions.transfer(_to, _value)
                                    .data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_owner, _spender], base_contract_1.BaseContract._bigNumberToString.bind(self)), _owner = _a[0], _spender = _a[1];
                                ethersFunction = self
                                    ._lookupEthersInterface(functionSignature)
    ...
    EtherTokenContract.deployFrom0xArtifactAsync = function (artifact, provider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            var bytecode, abi;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, EtherTokenContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    EtherTokenContract.deployAsync = function (bytecode, abi, provider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("EtherToken successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new EtherTokenContract(abi, txReceipt.contractAddress, provider, txDefaults);
...
exports.EtherTokenContract = EtherTokenContract;
//# sourceMappingURL=ether_token.js.map