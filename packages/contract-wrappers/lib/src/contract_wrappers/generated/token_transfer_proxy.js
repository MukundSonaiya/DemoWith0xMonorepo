...
var TokenTransferProxyEvents;
(function (TokenTransferProxyEvents) {
    TokenTransferProxyEvents["LogAuthorizedAddressAdded"] = "LogAuthorizedAddressAdded";
    TokenTransferProxyEvents["LogAuthorizedAddressRemoved"] = "LogAuthorizedAddressRemoved";
})(TokenTransferProxyEvents = exports.TokenTransferProxyEvents || (exports.TokenTransferProxyEvents = {}));
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var TokenTransferProxyContract = /** @class */ (function (_super) {
    __extends(TokenTransferProxyContract, _super);
    function TokenTransferProxyContract(abi, address, provider, txDefaults) {
        var _this = _super.call(this, 'TokenTransferProxy', abi, address, provider, txDefaults) || this;
        _this.transferFrom = {
            sendTransactionAsync: function (token, from, to, value, txData) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('transferFrom(address,address,address,uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [token, from, to, value], base_contract_1.BaseContract._bigNumberToString.bind(self)), token = _a[0], from = _a[1], to = _a[2], value = _a[3];
                                encodedData = self
                                    ._lookupEthersInterface('transferFrom(address,address,address,uint256)')
                                    .functions.transferFrom(token, from, to, value).data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.transferFrom.estimateGasAsync.bind(self, token, from, to, value))];
                            case 1:
            ...
            estimateGasAsync: function (token, from, to, value, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('transferFrom(address,address,address,uint256)').inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [token, from, to, value], base_contract_1.BaseContract._bigNumberToString), token = _a[0], from = _a[1], to = _a[2], value = _a[3];
                                encodedData = self
                                    ._lookupEthersInterface('transferFrom(address,address,address,uint256)')
                                    .functions.transferFrom(token, from, to, value).data;
            ...
            getABIEncodedTransactionData: function (token, from, to, value) {
                var self = this;
                var inputAbi = self._lookupAbi('transferFrom(address,address,address,uint256)').inputs;
                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [token, from, to, value], base_contract_1.BaseContract._bigNumberToString), token = _a[0], from = _a[1], to = _a[2], value = _a[3];
            ...
            callAsync: function (token, from, to, value, callData, defaultBlock) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                functionSignature = 'transferFrom(address,address,address,uint256)';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _a = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [token, from, to, value], base_contract_1.BaseContract._bigNumberToString.bind(self)), token = _a[0], from = _a[1], to = _a[2], value = _a[3];
                                ethersFunction = self
                                    ._lookupEthersInterface(functionSignature)
                                    .functions.transferFrom(token, from, to, value);
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                target = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [target], base_contract_1.BaseContract._bigNumberToString.bind(self))[0];
                                encodedData = self
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('addAuthorizedAddress(address)').inputs;
                                target = base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [target], base_contract_1.BaseContract._bigNumberToString)[0];
                                encodedData = self
                                    ._lookupEthersInterface('addAuthorizedAddress(address)')
                                    .functions.addAuthorizedAddress(target).data;
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
    ...
    TokenTransferProxyContract.deployFrom0xArtifactAsync = function (artifact, provider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            var bytecode, abi;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, TokenTransferProxyContract.deployAsync(bytecode, abi, provider, txDefaults)];
            });
        });
    };
    TokenTransferProxyContract.deployAsync = function (bytecode, abi, provider, txDefaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("TokenTransferProxy successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TokenTransferProxyContract(abi, txReceipt.contractAddress, provider, txDefaults);
    ...
    return TokenTransferProxyContract;
