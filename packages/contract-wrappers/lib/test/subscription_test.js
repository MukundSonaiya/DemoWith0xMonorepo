...
describe('SubscriptionTest', function () {
    ...
    describe('#subscribe', function () {
        ...
        it('Should receive the Error when an error occurs while fetching the block', function (done) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                var errMsg, callback;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            errMsg = 'Error fetching block';
                            callback = dev_utils_1.callbackErrorReporter.assertNodeCallbackError(done, errMsg);
                            stubs = [Sinon.stub(contractWrappers._web3Wrapper, 'getBlockAsync').throws(new Error(errMsg))];
        ...
        it('Should receive the Error when an error occurs while reconciling the new block', function (done) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                var errMsg, callback;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            errMsg = 'Error fetching logs';
                            callback = dev_utils_1.callbackErrorReporter.assertNodeCallbackError(done, errMsg);
                            stubs = [Sinon.stub(contractWrappers._web3Wrapper, 'getLogsAsync').throws(new Error(errMsg))];
                            contractWrappers.token.subscribe(tokenAddress, src_1.TokenEvents.Approval, indexFilterValues, callback);
                            return [4 /*yield*/, contractWrappers.token.setAllowanceAsync(tokenAddress, coinbase, addressWithoutFunds, allowanceAmount)];
                        case 1:
                            _a.sent();
        ...
        it('Should allow unsubscribeAll to be called successfully after an error', function (done) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    contractWrappers.token.subscribe(tokenAddress, src_1.TokenEvents.Approval, indexFilterValues, callback);
                    stubs = [
                        Sinon.stub(contractWrappers._web3Wrapper, 'getBlockAsync').throws(new Error('JSON RPC error')),
                    ];
                    contractWrappers.token.unsubscribeAll();
                    done();
                    return [2 /*return*/];
