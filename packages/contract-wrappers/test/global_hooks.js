...
var migrations_1 = require("@0xproject/migrations");
var web3_wrapper_1 = require("./utils/web3_wrapper");
before('migrate contracts', function () {
    return __awaiter(this, void 0, void 0, function () {
        var mochaTestTimeoutMs, txDefaults, artifactsDir;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, migrations_1.runV1MigrationsAsync(web3_wrapper_1.provider, artifactsDir, txDefaults)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
