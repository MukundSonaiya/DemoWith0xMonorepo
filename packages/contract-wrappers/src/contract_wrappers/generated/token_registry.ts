...
export class TokenRegistryContract extends BaseContract {
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return TokenRegistryContract.deployAsync(bytecode, abi, provider, txDefaults);
    }
    public static async deployAsync(
        ...
        logUtils.log(`TokenRegistry successfully deployed at ${txReceipt.contractAddress}`);
    ...
    constructor(abi: ContractAbi, address: string, provider: Provider, txDefaults?: Partial<TxData>) {
        super('TokenRegistry', abi, address, provider, txDefaults);
