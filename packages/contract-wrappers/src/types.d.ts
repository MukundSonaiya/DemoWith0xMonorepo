...
import { BlockParam, ContractEventArg, LogEntryEvent, LogWithDecodedArgs, Order, OrderState, SignedOrder } from '@0xproject/types';
...
export declare enum ContractWrappersError {
...
export declare enum InternalContractWrappersError {
