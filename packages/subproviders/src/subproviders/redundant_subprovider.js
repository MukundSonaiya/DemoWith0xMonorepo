...
var RedundantSubprovider = /** @class */ (function (_super) {
    ...
    RedundantSubprovider._firstSuccessAsync = function (subproviders, payload, next) {
        return __awaiter(this, void 0, void 0, function () {
            var lastErr, _i, subproviders_1, subprovider, data, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _i = 0, subproviders_1 = subproviders;
                        _a.label = 1;
                    case 1:
                        if (!(_i < subproviders_1.length)) return [3 /*break*/, 6];
                        subprovider = subproviders_1[_i];
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);
