...
describe('NonceTrackerSubprovider', function () {
    ...
    function createFixtureSubprovider() {
        ...
        var fixedBlockNumberAndTransactionCountProvider = new FixtureSubprovider({
            ...
            eth_getTransactionCount: function (data, next, end) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, utils_1.promisify(provider.sendAsync, provider)(payload)];
                case 1:
                    response = _a.sent();
            ...
            switch (_a.label) {
                case 0:
                    ...
                    provider.addProvider(new FixtureSubprovider({
                        eth_sendRawTransaction: function (data, next, end) {
                    ...
                    return [4 /*yield*/, utils_1.promisify(provider.sendAsync, provider)(noncePayload)];
                case 1:
                    response = _a.sent();
                    expect(response.result).to.be.eq('0x00');
                    return [4 /*yield*/, utils_1.promisify(provider.sendAsync, provider)(noncePayload)];
                ...
                case 3:
                    _a.trys.push([3, 5, , 7]);
                    return [4 /*yield*/, utils_1.promisify(provider.sendAsync, provider)(txPayload)];
                case 4:
                    _a.sent();
                    return [3 /*break*/, 7];
                case 5:
