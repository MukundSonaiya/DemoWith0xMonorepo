...
var Compiler = /** @class */ (function () {
    ...
    Compiler.prototype.compileAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var contractNamesToCompile, allContracts, _i, contractNamesToCompile_1, contractNameToCompile;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _i = 0, contractNamesToCompile_1 = contractNamesToCompile;
                        _a.label = 3;
                    case 3:
                        if (!(_i < contractNamesToCompile_1.length)) return [3 /*break*/, 6];
                        contractNameToCompile = contractNamesToCompile_1[_i];
    ...
    Compiler.prototype._compileContractAsync = function (contractName) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var contractSource, absoluteContractPath, currentArtifactIfExists, sourceTreeHashHex, shouldCompile, currentArtifact, isUserOnLatestVersion, didCompilerSettingsChange, didSourceChange, solcVersion, solcVersionRange, availableCompilerVersions, fullSolcVersion, compilerBinFilename, solcjs, isCompilerAvailableLocally, url, response, SUCCESS_STATUS, solcInstance, source, standardInput, compiled, SOLIDITY_WARNING_1, errors, warnings, compiledData, sourceCodes, contractVersion, newArtifact, currentArtifact, artifactString, currentArtifactPath, _a;
    ...
    Compiler.prototype._getSourceTreeHash = function (importPath) {
        ...
        if (dependencies.length === 0) {
            ...
            var sourceTreeHashesBuffer = Buffer.concat([sourceHash].concat(dependencySourceTreeHashes));
