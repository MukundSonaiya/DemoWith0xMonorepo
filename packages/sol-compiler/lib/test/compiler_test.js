...
describe('#Compiler', function () {
    var _this = this;
    this.timeout(constants_1.constants.timeoutMs);
    var artifactsDir = __dirname + "/fixtures/artifacts";
    var contractsDir = __dirname + "/fixtures/contracts";
    var exchangeArtifactPath = artifactsDir + "/Exchange.json";
    var compilerOpts = {
        artifactsDir: artifactsDir,
        contractsDir: contractsDir,
        contracts: constants_1.constants.contracts,
    };
    var compiler = new compiler_1.Compiler(compilerOpts);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, compiler.compileAsync()];
                    case 3:
                        _a.sent();
                        done();
                        return [2 /*return*/];
    ...
    it('should create an Exchange artifact with the correct unlinked binary', function () { return __awaiter(_this, void 0, void 0, function () {
        var opts, exchangeArtifactString, exchangeArtifact, metadataByteLength, metadataHexLength, unlinkedBinaryWithoutMetadata, exchangeBinaryWithoutMetadata;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    opts = {
